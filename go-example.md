```go
// =====================================================
// COMPLETE GOLANG CORE FEATURES DEMO
// =====================================================
//
// HOW TO INITIALIZE THE GO PROJECT (Step 1):
// 1. Open your terminal in an empty folder
// 2. Run: go mod init golang-features-demo
//    (this creates go.mod file)
// 3. Create a file named main.go
// 4. Paste the entire code below into main.go
// 5. Run the program: go run main.go
//
// This single file demonstrates EVERYTHING you asked for:
// - Data types (integers, floats, strings, chars)
// - Arrays, slices, structs + indexing
// - Writing JSON to a file
// - Concurrency (goroutines), context control, defer
// - Generics + polymorphism (interfaces)
// - All major control structures
//
// Go version required: 1.18+ (for generics)
// All code uses only the standard library.
